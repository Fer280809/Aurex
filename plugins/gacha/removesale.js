...
const handler = async (m, { conn, text }) => {
    if (!text) {
        return m.reply('❌ *Uso:* /removesale <nombre>\nEjemplo: /removesale Miku');
    }
    ...
    delete users[userId].harem[charIndex].listedAt;
...
handler.help = ['removesale', 'quitarventa'];
handler.tags = ['gacha'];
handler.command = ['removesale', 'quitarventa'];
handler.group = true;
