const handler = async (m, { conn, text, command, usedPrefix }) => {
    try {
        // ELIMINA ESTO: import db from '../../../database.js'
        // USA global.db directamente
        ...
        // CAMBIA ESTA LÍNEA:
        const user = global.db.data.users[m.sender]  // ← Usa global.db
        ...
        switch (command) {
            case 'advertencia': case 'warn': case 'addwarn': {
                ...
                // CAMBIA ESTO TAMBIÉN:
                user.warn = (user.warn || 0) + 1  // ← Ya usa global.db
