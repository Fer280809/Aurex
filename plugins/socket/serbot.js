...
// CREAR CONFIGURACIÓN INICIAL DEL SUBBOT
const defaultConfig = {
...
// INICIALIZAR CONFIGURACIÓN EN LA BASE DE DATOS
if (!global.db.data.settings[sock.user?.jid || '']) {
  global.db.data.settings[sock.user?.jid || ''] = {
    self: defaultConfig.mode === 'private',
    restrict: true,
    jadibotmd: true,
    antiPrivate: defaultConfig.antiPrivate,
    gponly: defaultConfig.gponly
  }
}
